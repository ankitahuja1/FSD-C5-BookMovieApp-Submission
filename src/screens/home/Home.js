...
import { Button, CardHeader, Card, CardContent, FormControl, TextField, MenuItem, Checkbox, InputLabel, Input, Select, ListItemText, GridList, GridListTile, GridListTileBar } from '@material-ui/core';
        ...
        <div>
            ...
            <div id="releasedMovies">
                <div className="releasedMovies">
                    <GridList cellHeight={350} cols={4} gap={16} >
                        {releasedMovies.map(releasedMovie => (

                            <GridListTile key={releasedMovie.id}>
